  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-gray-100 shadow-sm">
        ...
        {/* 카테고리 탭 바 */}
        <div className="max-w-6xl mx-auto px-4 pb-2 pt-1 flex gap-1.5 overflow-x-auto"
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-4 pt-4 pb-8">
        ...
        {isFiltered && (
          <div className="flex items-center justify-between mb-3">
            ...
            <button
              onClick={() => { setSearch(""); setCategory("전체"); setShowAll(false); }}
        ...
        <footer className="mt-10 pt-6 border-t border-gray-200 text-center">
          <p className="text-xs text-gray-300">
            © PLAY강릉 · 강릉의 소식을 가장 빠르게
          </p>
          <p className="text-[10px] text-gray-200 mt-1">
            이 화면은 새 홈 미리보기입니다. 기존 홈: <a href={`${BASE}/`} className="underline hover:text-gray-400">/</a>
          </p>
        </footer>
      </main>
    </div>
