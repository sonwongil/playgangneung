...
type EnrichedEvent = CrawledEvent & { category: string; thumbnail: string };
...
const MOCK_EVENTS: EnrichedEvent[] = [
  {
    ...
    socialDraft: null,
    cardImageUrl: null,
    crawledAt: "2026-05-06T09:00:00.000Z",
    category: "행사",
  ...
  },
  {
    ...
    socialDraft: null,
    cardImageUrl: null,
    crawledAt: "2026-05-06T08:30:00.000Z",
    category: "맛집",
  ...
  },
  {
    ...
    sourceType: "mock",
    status: "approved",
    socialDraft: "경포해변 일출을 소개합니다! 🌅",
    cardImageUrl: null,
    crawledAt: "2026-05-05T20:00:00.000Z",
    category: "핫플",
  ...
  },
  {
    ...
    socialDraft: null,
    cardImageUrl: null,
    crawledAt: "2026-05-01T10:00:00.000Z",
    category: "지역소식",
  ...
  },
  {
    ...
    socialDraft: null,
    cardImageUrl: null,
    crawledAt: "2026-05-03T11:00:00.000Z",
    category: "맛집",
  ...
  },
  {
    ...
    socialDraft: null,
    cardImageUrl: null,
    crawledAt: "2026-05-04T09:00:00.000Z",
    category: "행사",
  ...
  },
  {
    ...
    socialDraft: null,
    cardImageUrl: null,
    crawledAt: "2026-05-02T14:00:00.000Z",
    category: "핫플",
...
function enrichEvent(event: CrawledEvent & { category?: string; thumbnail?: string }): EnrichedEvent {
  ...
  return {
    ...event,
    category,
    thumbnail: event.thumbnail ?? thumbnailMap[category] ?? "https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=800&q=80",
  };
}
